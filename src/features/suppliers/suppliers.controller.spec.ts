...
describe('SuppliersController', () => {
  ...
  describe("getSupplierById", () => {
    it("should return a supplier by id", async () => {
      ...
      jest.spyOn(service, 'getSupplierById').mockResolvedValue(supplier as Supplier);
  ...
  describe("createSupplier", () => {
    it("should create and return a new supplier", async () => {
      const dto = { supplier_name: 'New Supplier', supplier_description: 'New Description' };
      const newSupplier = { supplier_id: 3, ...dto };
      jest.spyOn(service, 'createSupplier').mockResolvedValue(newSupplier as Supplier);
  ...
  describe("updateSupplier", () => {
    it("should update and return the supplier", async () => {
      const dto = { supplier_name: 'Updated Supplier', supplier_description: 'Updated Description' };
      const updatedSupplier = { supplier_id: 1, ...dto };
      jest.spyOn(service, 'updateSupplier').mockResolvedValue(updatedSupplier as Supplier);
